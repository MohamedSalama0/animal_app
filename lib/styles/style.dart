...
class AppStyles 
{
  ...
  static const Color greenColor = Color.fromARGB(181, 57, 139, 66);
  static const Color darkColor = Color(0xff023047);
  static const Color yellowColor = Color(0xffE3BD49);
